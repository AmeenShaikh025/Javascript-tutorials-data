...
document.querySelector('.btn-roll').addEventListener('click', function() { /*anonymous function, a function that does not have a name and cannot be reused*/
	...
	if(gamePlaying){
			...
			//1. Random number
			 var dice1 = Math.floor(Math.random() *6) + 1;// var used only in this scope
			...
			//querySelector selects only the first occurance of the string (or) else use querySelectorAll()
			...
			if (dice1 !== 1 && dice2 !== 1){   /*!==  --> doesn't do type coversion, !=  --> does type coversion */
				//Add score
...
/*=======================================CODING CHALLENGE 3-01===========================================*/			
/*			if(dice === 6 && lastDice === 6){
				//Player looses score
				scores[activePlayer] = 0;
				document.querySelector('#score-'+ activePlayer).textContent = '0';
				nextPlayer();
			}else if (dice !== 1){   !==  --> doesn't do type coversion, !=  --> does type coversion 
				//Add score
				roundScore += dice;
				document.querySelector('#current-' + activePlayer).textContent = roundScore;
			}
...
/*===============================coding challenge 2=============================================*/
			...
			var winningScore
			//udefined, 0 ,null or "" are coereced to false
